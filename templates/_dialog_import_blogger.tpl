<p>
    {_ Upload a GData XML file from your computer. _}
</p>


{% wire id=#form type="submit" delegate="mod_import_blogger" postback={blogger_upload} %}
<form id="{{ #form }}" method="POST" action="postback">
    <div class="new-media-wrapper">

        <div class="form-item clearfix">
            <label for="upload_file">{_ GData file _}</label>
